	      ...
	      <div class="panel-body"> 
	           <fieldset>
	              <div class="form-group">
	                 <label class="col-md-1 control-label"  style="width:100px;" for="dequipmentName">设备名称</label>
	                 ...
	                 <label class="col-md-1 control-label" for="dgroupNo"  style="width:100px;">专业</label>
	                 <div class="col-md-2" style="width:180px;">                
	                 ...
	                 <label class="col-md-1 control-label" for="dsubGroupNo" style="width:100px;">专业类别</label>
	                 <div class="col-md-2" style="width:180px;">                
	           ...
	           <fieldset style="margin-top:10px">
	              <div class="form-group">  
	                 <label class="col-md-1 control-label" for="dsort" style="width:100px;">排序</label>
	                 <div class="col-md-2"  style="width:180px;">
	                    <input type="text" class="form-control" id="dsort">
	                 </div>
	                 
	                 <label class="col-md-1 control-label" for="dremark" style="width:100px;">备注</label>
	                 <div class="col-md-2"  style="width:180px;">
	           ...
	           <fieldset style="margin-top:10px">
	              <div class="form-group">
	                  <div class="col-md-1">
	                  <button type="button" class="btn btn-primary btn-sm" id="updateEquipmentBtn">保存</button>
	                  </div>                  
	               </div>  
	            </fieldset>       
		  </div>
